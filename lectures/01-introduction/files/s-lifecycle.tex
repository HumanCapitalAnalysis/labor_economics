...
Why do economists use mathematical models? (\href{https://github.com/HumanCapitalAnalysis/talks/blob/master/research-skills/02-mathematical-modeling/slides.pdf}{slides})
\end{frame}
%-------------------------------------------------------------------------------
%-------------------------------------------------------------------------------
